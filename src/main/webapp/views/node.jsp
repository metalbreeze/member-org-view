	...
	<tr>
		<td>
			<form:label path="group.id">
				<spring:message text="选择组"/>
			</form:label>
		</td>
		<td>
			<form:select path="group.id" 
			headerKey="-1" headerValue="选择组"
	...
	<tr>
		<td>
			<form:label path="parent.id">
				<spring:message text="选择上级"/>
			</form:label>
		</td>
		<td>
			<form:select path="parent.id" 
			headerKey="-1" headerValue="选择上级"
				list="parentList" listKey="id" listValue="name" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
